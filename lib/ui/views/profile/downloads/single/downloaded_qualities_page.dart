...
class DownloadedQualitiesPage extends StatefulWidget {
  static const routeName = '/download-single-qualities';

  @override
  State<DownloadedQualitiesPage> createState() =>
      _DownloadedQualitiesPageState();
}

class _DownloadedQualitiesPageState extends State<DownloadedQualitiesPage> {
  String movie_name = '';
  String image = '';
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "${(task.size * task.progress).abs().toHumanReadableFileSize()} | ${(task.size).abs().toHumanReadableFileSize()}",
                                        style: GoogleFonts.ubuntu(
                                          textStyle: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.w400,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "Qoldi: ${prettyDuration(Duration(seconds: task.remainingTime))}",
                                        style: GoogleFonts.ubuntu(
                                          textStyle: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.w400,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "${(task.size * task.progress).abs().toHumanReadableFileSize(round: 2)} | ${(task.size).abs().toHumanReadableFileSize(round: 2)} | ${(task.networkSpeed).abs().toStringAsFixed(2)} MB/s",
                                        style: GoogleFonts.ubuntu(
                                          textStyle: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.w400,
                                      ...
                                      try {
                                        ...
                                        if (!tariffExists) {
                                          ...
                                          Navigator.of(context).pushNamed(
                                              ...
                                              arguments: {
                                                'tariff_filter': task.tariff,
                                              });
                                          return;
                                        }

                                        //proceed to watch
                                        File file = File(task.path);
                                        bool exists = await file.exists();
                                        if (exists)
                                          Navigator.of(context).pushNamed(
                                              VideoPlayerPageOffline.routeName,
                                              arguments: {
                                                'movie_name': task.displayName,
                                                'profile': profile,
                                                'videoUrl': file.path,
                                              });
                                      } catch (e) {
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        "${task.size.abs().toHumanReadableFileSize(round: 1)}",
                                        style: GoogleFonts.ubuntu(
                                          textStyle: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.w400,
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          onPressed: () {
                            openPauseDialog(context, task.taskId, task.name);
                          },
